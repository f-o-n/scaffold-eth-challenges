...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  console.log("\n 🏵  Sending all 5000 tokens to the vendor...");
  ...
  console.log("\n ✅ confirming...\n");
  await sleep(2000); // wait 5 seconds for transaction to propagate

  // change address to your frontend address 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
  //console.log("\n 🤹  Sending ownership to frontend address...\n")
  //const ownershipTransaction = await vendor.transferOwnership("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266" );
  console.log("\n 🤹  Renouncing ownership...\n")
  const ownershipTransaction = await vendor.renounceOwnership();
  console.log("\n ✅ confirming...\n");
